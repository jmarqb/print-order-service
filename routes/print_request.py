...
async def update_request_type_passport(
    ...
    return await print_request_service.update_by_id_and_document_type(
        print_request_id, update_body_request, DocumentType.PASSPORT, owner
    )
...
async def update_request_type_accreditation(
    ...
    return await print_request_service.update_by_id_and_document_type(
        print_request_id, update_body_request, DocumentType.ACCREDITATION, owner
    )
...
async def update_request_type_dni(
    ...
    return await print_request_service.update_by_id_and_document_type(
        print_request_id, update_body_request, DocumentType.DNI, owner
    )
